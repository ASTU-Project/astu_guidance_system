            ...
            <div class="relative w-full max-w-lg rounded-md bg-white p-6 shadow-2xl">
                ...
                <form action="#" method="POST" class="mt-5 space-y-4">
                    <div>
                        ...
                        <input id="update-location-name" type="text" class="w-full rounded-md border border-slate-200 px-3 py-2 text-sm text-slate-700 focus:border-slate-400 focus:outline-none" placeholder="e.g. Main Library">
                    </div>

                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                            <label for="update-location-latitude" class="mb-1 block text-sm font-medium text-slate-700">Latitude</label>
                            <input id="update-location-latitude" type="number" step="0.0000001" class="w-full rounded-md border border-slate-200 px-3 py-2 text-sm text-slate-700 focus:border-slate-400 focus:outline-none" placeholder="9.0320000">
                        </div>
                        <div>
                            <label for="update-location-longitude" class="mb-1 block text-sm font-medium text-slate-700">Longitude</label>
                            <input id="update-location-longitude" type="number" step="0.0000001" class="w-full rounded-md border border-slate-200 px-3 py-2 text-sm text-slate-700 focus:border-slate-400 focus:outline-none" placeholder="38.7630000">
                        </div>
                    </div>

                    <div>
                        <label for="update-location-description" class="mb-1 block text-sm font-medium text-slate-700">Description</label>
                        <textarea id="update-location-description" rows="3" class="w-full rounded-md border border-slate-200 px-3 py-2 text-sm text-slate-700 focus:border-slate-400 focus:outline-none" placeholder="Short description of this place"></textarea>
                    </div>

                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                            <label for="update-location-category" class="mb-1 block text-sm font-medium text-slate-700">Category</label>
                            <select id="update-location-category" class="w-full rounded-md border border-slate-200 px-3 py-2 text-sm text-slate-700 focus:border-slate-400 focus:outline-none">
                                <option value="">Select category</option>
                        ...
                        <div>
                            ...
                            <select id="update-location-icon" class="w-full rounded-md border border-slate-200 px-3 py-2 text-sm text-slate-700 focus:border-slate-400 focus:outline-none">
